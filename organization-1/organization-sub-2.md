...
조직 사용자 관리로 들어가면 좌측 상단에 현재 선택되어 있는 \[조직명\]을 통해 선택할 수 있으며, 선택된 조직의 사용자 목록을 확인할 수 있습니다.
...
> **안내 :** 사용자 추가는 이미 가입을 했으며, 기업 내에 속해 있는 사용자를 추가할 수 있으며, 사용자 초대는 아직 가입하지 않는 사용자를 대상으로 사용자의 메일에 초대 메시지를 보낼 수 있으며, 해당 사용자가 가입 시 기업관리자는 사용자 추가를 통해 해당 조직에 가입시킬 수 있습니다.
