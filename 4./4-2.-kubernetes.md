...
\[Intro &gt; User Guide\] Kubernetes 유용하게 사용할 수 있는 가이드 페이지입니다. 기능별 대략적인 설명이 기술되어 있고 상세한 가이드 내용은 오른쪽 링크를 통해서 확인 가능합니다.

![](../.gitbook/assets/image%20%28145%29.png)

{% hint style="info" %}
UserGuide수행 이전에  Role별 권한 정보를 확인합니다. Role에 대한 권한은 서비스 관리자에게 있으며 관리자가 
